...
typedef struct
{
    ...
    fp32 leg_dlength_L,leg_dlength_R,last_leg_dlength_L,last_leg_dlength_R,leg_dlength_L_kf,leg_dlength_R_kf,last_leg_dlength_L_kf,last_leg_dlength_R_kf,leg_dlength_L_jacobian, leg_dlength_R_jacobian;
