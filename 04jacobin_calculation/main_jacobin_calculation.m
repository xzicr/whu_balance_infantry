...
test_l3 = 0.30;
test_theta3 = 30;
test_theta_rad3 = test_theta3 * pi/180;
[phi1, phi2] = solve_kinematics_accurate(test_l3, test_theta_rad3);
[J1 ,J2, J3, J4] = calculate_jacobian_elements(test_l3, test_theta_rad3);
J_inv=[J1 ,J2 ;J3, J4];
J=inv(J_inv);
J_transpose=J';
J1 = J_transpose(1,1);
